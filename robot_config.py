...
# 시뮬 근거(20시드 스윕): 충돌 0 = 100/200/250mm, 충돌 발생 = 300mm(1시드)
# / 400mm(7시드) / 800mm(5시드). 즉 안전 경계는 250~300 사이다.
# ★250 이 아니라 200 을 고른 이유: (1) 실물 횡방향 오차가 시뮬엔 아예
#   없어서 시뮬 상한은 과대평가다 (2) 20시드에서 충돌 0 은 "진짜 0" 의
#   증거로 약하다 - 경계(300)에 인접한 250 보다 한 칸 물러선다.
SMOOTH_MAX_MM = 200.0   # ★실물 미검증 (path_planner_sim2 가 자체 사본을 씀)

MS_PER_MM = 4.0         # TODO: 미측정 (motor_commander 의 현재 가정값 사본)
MS_PER_DEG = 10.0       # TODO: 미측정 (동상)
MOVE_ACCEL_MS = 0.0     # TODO: 미측정 — 위 식의 절편 C
